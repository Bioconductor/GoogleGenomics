...
This is good, but this data becomes **way** more useful when it is converted to native Bioconductor data types.  For example, we can convert reads in this list representation to `r Biocpkg("GAlignments")`:
```{r}
